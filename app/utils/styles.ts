...
/**
 * Convert ms token values to raw numbers for RTG transition delay props
 */
...
/**
 * Convert an rgb theme property (e.g. "0 0 0")
 * to values that can be spread into a ThreeJS Color class
 */
export const rgbToThreeColor = (rgb?: string | null): number[] =>
