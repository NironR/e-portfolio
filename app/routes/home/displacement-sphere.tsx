...
type DisplacementSphereProps = React.ComponentPropsWithoutRef<'canvas'>;
...
export const DisplacementSphere = (props: DisplacementSphereProps) => {
    ...
    const lights = useRef<Array<AmbientLight | DirectionalLight> | null>(null);
    ...
    useEffect(() => {
        ...
        startTransition(() => {
            ...
            // Removed non-existent property assignment `modifier`
