...
type ViewportKey = "desktop" | "laptop" | "tablet" | "mobile" | "mobileS";

export interface TokensByViewport {
    base: ThemeTokens;
    desktop: ThemeTokens;
    laptop: ThemeTokens;
    tablet: ThemeTokens;
...
const baseTokens: ThemeTokens = {
    ...
    fontStack: `"Proxima Nova", "Halis GR", "Blender Pro", "NanumSquare", var(--systemFontStack)`,
    monoFontStack:
...
const tokensDesktop: ThemeTokens = {
    fontSizeH0: pxToRem(120),
    fontSizeH1: pxToRem(80)
};

const tokensLaptop: ThemeTokens = {
    maxWidthS: "480px",
    maxWidthM: "640px",
    maxWidthL: "1000px",
    maxWidthXL: "1100px",
...
const tokensTablet: ThemeTokens = {
...
const tokensMobile: ThemeTokens = {
    spaceOuter: "24px",
...
const tokensMobileSmall: ThemeTokens = {
    spaceOuter: "16px",
...
export const tokens: TokensByViewport = {
    base: baseTokens,
...
export type ThemeName = keyof typeof themes; // "dark" | "light"
